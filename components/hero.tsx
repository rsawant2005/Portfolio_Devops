      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          ...
          <h1 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            ROSHAN
            <br />
            <span className="italic">SAWANT</span>
          </h1>
        </motion.div>

        {/* Bottom Row — Get In Touch (left) + DEVOPS ENGINEER (right) */}
        <div className="flex items-end justify-between">
          {/* Bottom Left — Get In Touch button */}
          <motion.div
          ...
          >
            <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">02 — DISCIPLINE</p>
