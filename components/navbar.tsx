    ...
    <>
      ...
      >
        <nav className="flex items-center justify-between px-6 py-4 my-0 md:px-12 md:py-5">
          ...
          >
            <span className="font-mono text-xs tracking-widest text-muted-foreground">RS</span>
            <span className="w-1.5 h-1.5 rounded-full bg-[#7c3aed] group-hover:scale-150 transition-transform duration-300" />
          ...
          <ul className="hidden md:flex items-center gap-8">
            {navLinks.map((link, index) => (
              <li key={link.label}>
                ...
                >
                  <span className="text-[#7c3aed] mr-1">0{index + 1}</span>
          ...
          >
            <nav className="flex flex-col items-center justify-center h-full gap-8">
              {navLinks.map((link, index) => (
                ...
                >
                  <span className="text-[#7c3aed] font-mono text-sm mr-2">0{index + 1}</span>
                  {link.label}
                </motion.button>
              ))}
              <motion.div
